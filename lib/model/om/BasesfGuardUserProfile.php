...
abstract class BasesfGuardUserProfile extends BaseObject  implements Persistent {
	...
	public function setBalance($v)
	{
		...
		if ($this->balance !== $v) {
			$this->balance = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::BALANCE;
		}
	...
	public function setAuthKey($v)
	{
		...
		if ($this->auth_key !== $v) {
			$this->auth_key = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::AUTH_KEY;
		}
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(sfGuardUserProfilePeer::CREATED_AT))
				{
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::BALANCE)) $criteria->add(sfGuardUserProfilePeer::BALANCE, $this->balance);
		if ($this->isColumnModified(sfGuardUserProfilePeer::NICKNAME)) $criteria->add(sfGuardUserProfilePeer::NICKNAME, $this->nickname);
		if ($this->isColumnModified(sfGuardUserProfilePeer::AUTH_KEY)) $criteria->add(sfGuardUserProfilePeer::AUTH_KEY, $this->auth_key);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setAuthKey($this->auth_key);
