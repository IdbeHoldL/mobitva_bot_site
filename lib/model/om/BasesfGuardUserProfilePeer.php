...
abstract class BasesfGuardUserProfilePeer {
	...
	const BALANCE = 'sf_guard_user_profile.BALANCE';
	...
	const AUTH_KEY = 'sf_guard_user_profile.AUTH_KEY';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Balance', 'Nickname', 'AuthKey', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'balance', 'nickname', 'authKey', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::BALANCE, self::NICKNAME, self::AUTH_KEY, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'balance', 'nickname', 'auth_key', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Balance' => 2, 'Nickname' => 3, 'AuthKey' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'balance' => 2, 'nickname' => 3, 'authKey' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::BALANCE => 2, self::NICKNAME => 3, self::AUTH_KEY => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'balance' => 2, 'nickname' => 3, 'auth_key' => 4, 'created_at' => 5, 'updated_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfGuardUserProfilePeer::BALANCE);
		$criteria->addSelectColumn(sfGuardUserProfilePeer::NICKNAME);
		$criteria->addSelectColumn(sfGuardUserProfilePeer::AUTH_KEY);
