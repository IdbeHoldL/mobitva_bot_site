...
abstract class Basemessages extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the is_readed field.
	 * @var        boolean
	 */
	protected $is_readed;
	...
	/**
	 * Get the [is_readed] column value.
	 * 
	 * @return     boolean
	 */
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = messagesPeer::USER_ID;
		}
	...
	public function setFrom($v)
	{
		...
		if ($this->from !== $v) {
			$this->from = $v;
			$this->modifiedColumns[] = messagesPeer::FROM;
		}
	...
	public function setTitle($v)
	{
		...
		if ($this->title !== $v) {
			$this->title = $v;
			$this->modifiedColumns[] = messagesPeer::TITLE;
		}
	...
	public function setBody($v)
	{
		...
		if ($this->body !== $v) {
			$this->body = $v;
			$this->modifiedColumns[] = messagesPeer::BODY;
		}
	...
	/**
	 * Set the value of [is_readed] column.
	 * 
	 * @param      boolean $v new value
	 * @return     messages The current object (for fluent API support)
	 */
	public function setIsReaded($v)
	{
		if ($v !== null) {
			$v = (boolean) $v;
		}
		...
		if ($this->is_readed !== $v) {
			$this->is_readed = $v;
			$this->modifiedColumns[] = messagesPeer::IS_READED;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->from = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->title = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->body = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->is_readed = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
			...
			return $startcol + 8; // 8 = messagesPeer::NUM_COLUMNS - messagesPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setIsReaded($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(messagesPeer::USER_ID)) $criteria->add(messagesPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(messagesPeer::FROM)) $criteria->add(messagesPeer::FROM, $this->from);
		if ($this->isColumnModified(messagesPeer::TITLE)) $criteria->add(messagesPeer::TITLE, $this->title);
		if ($this->isColumnModified(messagesPeer::BODY)) $criteria->add(messagesPeer::BODY, $this->body);
		if ($this->isColumnModified(messagesPeer::IS_READED)) $criteria->add(messagesPeer::IS_READED, $this->is_readed);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIsReaded($this->is_readed);
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->asfGuardUser->addmessagess($this);
			 */
		}
