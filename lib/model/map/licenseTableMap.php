...
class licenseTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.licenseTableMap';
    ...
    $this->addRelation('licenseCharsPlaces', 'licenseCharsPlaces', RelationMap::ONE_TO_MANY, array('id' => 'license_id', ), 'CASCADE', null);
	} // buildRelations()
