...
abstract class BasesfGuardUserPeer {
	...
	public static function clearRelatedInstancePool()
	{
		...
		// invalidate objects in messagesPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		messagesPeer::clearInstancePool();

		// invalidate objects in botSessionPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		botSessionPeer::clearInstancePool();

		// invalidate objects in botconfigPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		...
		// invalidate objects in balanceOperationPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related messages objects
			$criteria = new Criteria(messagesPeer::DATABASE_NAME);
			
			$criteria->add(messagesPeer::USER_ID, $obj->getId());
			$affectedRows += messagesPeer::doDelete($criteria, $con);

			// delete related botSession objects
			$criteria = new Criteria(botSessionPeer::DATABASE_NAME);
			
			$criteria->add(botSessionPeer::USER_ID, $obj->getId());
			$affectedRows += botSessionPeer::doDelete($criteria, $con);

			// delete related botconfig objects
			$criteria = new Criteria(botconfigPeer::DATABASE_NAME);
			
			$criteria->add(botconfigPeer::USER_ID, $obj->getId());
			$affectedRows += botconfigPeer::doDelete($criteria, $con);

			// delete related crosUserConfig objects
			$criteria = new Criteria(crosUserConfigPeer::DATABASE_NAME);
			
			$criteria->add(crosUserConfigPeer::USER_ID, $obj->getId());
			...
			$criteria->add(licensePeer::USER_ID, $obj->getId());
			$affectedRows += licensePeer::doDelete($criteria, $con);

			// delete related balanceOperation objects
			$criteria = new Criteria(balanceOperationPeer::DATABASE_NAME);
			
			$criteria->add(balanceOperationPeer::USER_ID, $obj->getId());
			$affectedRows += balanceOperationPeer::doDelete($criteria, $con);
