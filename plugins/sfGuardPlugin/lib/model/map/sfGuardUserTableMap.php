...
class sfGuardUserTableMap extends TableMap {
    ...
    $this->addRelation('messages', 'messages', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null);
    $this->addRelation('botSession', 'botSession', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null);
    $this->addRelation('botconfig', 'botconfig', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null);
    $this->addRelation('crosUserConfig', 'crosUserConfig', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null);
    $this->addRelation('license', 'license', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null);
    $this->addRelation('balanceOperation', 'balanceOperation', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null);
